...
- **Robust Security**: The engine aggressively verifies the curve equation <i>y</i><sup>2</sup> = <i>x</i><sup>3</sup> + 3 (mod <i>p</i>) and subgroup integrity. Malicious points intentionally trigger a Rust panic to prevent bypass vulnerabilities.
---
